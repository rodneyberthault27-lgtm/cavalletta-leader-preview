  ...
  return (
    <main className="model-detail-page">
      ...
      <header className="site-header model-detail-header">
        ...
        <nav className="main-tabs" aria-label="Navegação principal"><Link href="/#modelos">Modelos</Link><Link href="/#economia">Autonomia</Link><Link href="/#tecnologia">Tecnologia</Link><Link href="/#manutencao">Suporte</Link><Link href="/faq">FAQ</Link></nav>
      ...
      <section className="model-detail-hero">
        ...
        <div className="model-detail-stage"><img src={model.image} alt={model.fullName} /><span>{model.range ? `Até ${model.range} km de autonomia informada` : "Ficha técnica em atualização"}</span></div>
      </section>
